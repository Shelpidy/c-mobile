...
const UserProductScreen = ({ navigation,route }: ProductsComponentProps) => {
   ...
   let fetchProducts = async (pageNum?: number) => {
      ...
      try {
         ...
         let response = await fetch(
            `http://192.168.148.183:5000/api/marketing/products/user/${userId}/${currentUser?.id}/${pageNumber}/${numberOfPostsPerPage}`
         );
