...
const ProductScreen = ({ navigation, route }: any) => {
         ...
         let fetchData = async () => {
            ...
            try {
               let { data } = await axios.get(
                  `http://192.168.232.183:5000/api/marketing/products/${productId}`
               );
   ...
   useEffect(
      function () {
         let fetchData = async () => {
            ...
            try {
               let { data } = await axios.get(
                  `http://192.168.232.183:5000/api/marketing/products/cl/${productId}`
               );
               if (data.status == "success") {
         ...
         let fetchData = async () => {
            ...
            try {
               let response = await fetch(
                  `http://192.168.232.183:5000/api/auth/users/${userId}`,
                  { method: "GET" }
               );
   ...
   const handleProductRequest = async () => {
      ...
      try {
         let { data } = await axios.post(
            `http://192.168.232.183:5000/api/marketing/products/request/`,
            requestObj
         );
         if (data.status == "success") {
            Alert.alert(
   ...
   const handleProductAffiliate = async () => {
      ...
      try {
         let { data } = await axios.post(
            `http://192.168.232.183:5000/api/marketing/affiliates/`,
            requestObj
         );
         if (data.status == "success") {
            if (currentUser) {
   ...
   const handleComment = async () => {
      ...
      try {
         let { data } = await axios.post(
            `http://192.168.232.183:5000/api/marketing/products/comments/`,
            commentObj
         );
         if (data.status == "success") {
            console.log(data.data);
   ...
   const handleBuy = async () => {
      try {
         ...
         console.log(buyObj);
         let { data } = await axios.post(
            `http://192.168.232.183:5000/api/marketing/buy`,
            buyObj
         );
         if (data.status == "success") {
            console.log(data.data);
   ...
   const handleLike = async (productId: number) => {
      ...
      try {
         ...
         let { data } = await axios.put(
            `http://192.168.232.183:5000/api/marketing/products/likes/`,
