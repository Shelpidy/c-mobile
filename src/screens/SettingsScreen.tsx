  ...
  return (
    < ScrollView style={styles.container}>
      ...
      <View style={styles.content}>
        <List.Section>
          <List.Subheader style={{fontFamily:"Poppins_600SemiBold",fontSize:16,textAlign:"center"}}><MaterialCommunityIcons size={23} name='account-cog-outline'/> General</List.Subheader>
          <Divider/>
          <List.Item
        ...
        <List.Section>
          <List.Subheader style={{fontFamily:"Poppins_600SemiBold",fontSize:16,textAlign:"center"}}><MaterialCommunityIcons size={23} name='phone-plus-outline' /> Contact Info </List.Subheader>
           <Divider/>
          <List.Item
           titleStyle={styles.headerTitle}
        ...
        <List.Section>
         <List.Subheader style={{fontFamily:"Poppins_600SemiBold",fontSize:16,textAlign:"center"}}><AntDesign size={23} name='lock' /> Privacy </List.Subheader>
          <Divider/>
          <List.Item
           titleStyle={styles.headerTitle}
          ...
          <List.Subheader style={{fontFamily:"Poppins_600SemiBold",fontSize:16,textAlign:"center"}}><MaterialCommunityIcons size={23} name='cogs' /> Other Account Settings</List.Subheader>
          <Divider/>
          <List.Item
           titleStyle={styles.headerTitle}
