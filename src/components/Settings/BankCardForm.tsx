...
const reducer = (state: BankCardState, action: BankCardAction): BankCardState => {
  switch (action.type) {
  ...
  return (
    <View style={styles.container}>
      <TextInput
        ...
        onChangeText={(value) => handleInputChange('SET_CARD_NUMBER', value)}
        mode="outlined"
        left={
          <TextInput.Icon
            icon={() => (
      ...
      <TextInput
        ...
        onChangeText={(value) => handleInputChange('SET_EXPIRY_DATE', value)}
        mode="outlined"
        left={
          <TextInput.Icon
            icon={() => (
      ...
      <TextInput
        ...
        onChangeText={(value) => handleInputChange('SET_BILLING_ADDRESS', value)}
        mode="outlined"
        left={
          <TextInput.Icon
            icon={() => (
      ...
      <TextInput
        ...
        onChangeText={(value) => handleInputChange('SET_CASH_HOLDER_NAME', value)}
        mode="outlined"
        left={
          <TextInput.Icon
            icon={() => (
